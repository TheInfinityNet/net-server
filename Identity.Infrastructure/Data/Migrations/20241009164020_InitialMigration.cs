        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_account_providers_accounts_account_id1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_verifications_accounts_account_id1",
                        column: x => x.account_id1,
                        principalTable: "accounts",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_account_providers_account_id1",
                table: "account_providers",
                column: "account_id1");

            migrationBuilder.CreateIndex(
                name: "IX_verifications_account_id1",
                table: "verifications",
                column: "account_id1");
        }
