...
using InfinityNetServer.Services.Tag.Presentation.Services;
using InfinityNetServer.Services.Tag.Presentation.Exceptions;
using InfinityNetServer.Services.Tag.Infrastructure.DependencyInjection;
using InfinityNetServer.Services.Tag.Application;

namespace InfinityNetServer.Services.Tag.Presentation.Configurations;
...
internal static class HostingExtensions
{
    ...
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        var identityLocalizer = serviceProvider.GetRequiredService<IStringLocalizer<TagSharedResource>>();
