...
{
    public class HttpCommentExceptionHandler : IMiddleware
    {

        private readonly ILogger<HttpCommentExceptionHandler> _logger;

        private readonly IStringLocalizer<CommentSharedResource> _localizer;

        public HttpCommentExceptionHandler(ILogger<HttpCommentExceptionHandler> logger, IStringLocalizer<CommentSharedResource> localizer)
        {
            _logger = logger;
