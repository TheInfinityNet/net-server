...
{
    public class HttpFileExceptionHandler(ILogger<HttpFileExceptionHandler> logger, IStringLocalizer<FileSharedResource> localizer) : IMiddleware
    {
        ...
        private Dictionary<string, string> GetDetailedErrors(FileError error)
        {
