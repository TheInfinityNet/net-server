...
using InfinityNetServer.Services.Reaction.Infrastructure.DependencyInjection;
...
internal static class HostingExtensions
{
    ...
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        var identityLocalizer = serviceProvider.GetRequiredService<IStringLocalizer<ReactionSharedResource>>();
        ...
        builder.Services.AddTransient<HttpReactionExceptionHandler>();
    ...
    public static WebApplication ConfigurePipeline(this WebApplication app, IConfiguration configuration)
    {
        ...
        app.UseMiddleware<HttpReactionExceptionHandler>();
