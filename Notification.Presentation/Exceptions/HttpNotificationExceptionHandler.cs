...
using InfinityNetServer.Services.Notification.Application.Exceptions;

namespace InfinityNetServer.Services.Notification.Presentation.Exceptions
{
    public class HttpNotificationExceptionHandler : IMiddleware
    {

        private readonly ILogger<HttpNotificationExceptionHandler> _logger;

        private readonly IStringLocalizer<NotificationSharedResource> _localizer;

        public HttpNotificationExceptionHandler(ILogger<HttpNotificationExceptionHandler> logger, IStringLocalizer<NotificationSharedResource> localizer)
        {
            _logger = logger;
