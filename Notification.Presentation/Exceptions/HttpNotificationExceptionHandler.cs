...
{
    public class HttpNotificationExceptionHandler(ILogger<HttpNotificationExceptionHandler> logger, IStringLocalizer<NotificationSharedResource> localizer) : IMiddleware
    {
        ...
        private Dictionary<string, string> GetDetailedErrors(NotificationError error)
        {
